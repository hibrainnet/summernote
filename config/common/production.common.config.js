...
const webPath = `commons/libs/summernote/${process.env.HBN_ENV || 'development'}/`;
...
module.exports = {
  ...
  output: {
    ...
    filename: (chunkData) => {
      ...
      return isProduct ? `${webPath}[name].js` : `lang/[name].js`;
    },
  },
  externals: {
    jquery: {
  ...
  plugins: [
    ...
    new webpack.SourceMapDevToolPlugin({
      ...
      filename: `${webPath}[name].js.map`,
    }),
    new ZipPlugin({
      filename: `${webPath}summernote-${pkg.version}-dist.zip`,
      path: webPath,
    }),
  ],
};
